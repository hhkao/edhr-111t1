...
##### 1101 (含20校試辦)公立學校 教員資料表#####
  #國立
teacher_1101_1 <- readxl :: read_excel("C:/edhr-111t1/110學年度上學期高級中等學校教育人力資源資料庫（國立學校人事）.xlsx", sheet = "教員資料表")
  #縣市立
teacher_1101_2 <- readxl :: read_excel("C:/edhr-111t1/110學年度上學期高級中等學校教育人力資源資料庫（縣市立學校人事）_不含樟樹.xlsx", sheet = "教員資料表")

teacher_1101 <- bind_rows(teacher_1101_1, teacher_1101_2)

teacher_1101 <- teacher_1101 %>%
